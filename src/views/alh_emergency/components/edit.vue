        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="设备编号" prop="customerCode">
              <el-input v-model="temp.customerCode1" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="告警等级" prop="customerCode">
              <el-input v-model="temp.customerCode3" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="告警详情" prop="customerCode">
              <el-input v-model="temp.customerCode4" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="所属部门" prop="customerCode">
              <el-input v-model="temp.customerCode5" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="告警时间" prop="customerCode">
              <el-input v-model="temp.customerCode6" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="状态" prop="type1">
...
export default {
  ...
  methods: {
    show(row) {
      this.visible = true
      this.temp = {
        customerCode1: row.code1,
        customerCode2: row.code2,
        customerCode3: row.code3,
        customerCode4: row.code4,
        customerCode5: row.code5,
        customerCode6: row.code6,
        type1: row.type1
      }
    },
    submitForm() {
