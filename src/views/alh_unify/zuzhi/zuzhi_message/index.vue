        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="岗位编号">
                    <el-input v-model="listQuery.filter" placeholder="请输入岗位编号"></el-input>
                </el-form-item>
                <el-form-item label="岗位名称">
                    <el-input v-model="listQuery.filter" placeholder="请输入岗位名称"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                style="width: 100%">
                <el-table-column label="岗位编号" prop="index" align="center" min-width="50">
                    <template slot-scope="{ row }">
                        <span>{{ row.index }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="岗位名称" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="所属组织" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
