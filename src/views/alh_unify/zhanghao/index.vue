        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="账号">
                    <el-input v-model="listQuery.filter" placeholder="请输入账号"></el-input>
                </el-form-item>
                ...
                <el-form-item>
                    ...
                    <el-button class="filter-item" style="margin-left: 10px" type="primary"
                        icon="el-icon-top">账号同步</el-button>
                </el-form-item>
            </el-form>
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                ...
                <el-table-column label="账号" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="部门" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="云数据处理中心" prop="type1" align="center">
                    <template slot-scope="{ row }">
                        <el-tag>{{ row.type1 == 0 ? 'X' : '√' }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column label="统一用户系统管理" prop="type2" align="center">
                    <template slot-scope="{ row }">
                        <el-tag>{{ row.type2 == 0 ? 'X' : '√' }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column label="综合应用管理系统" prop="type3" align="center">
                    <template slot-scope="{ row }">
                        <el-tag>{{ row.type3 == 0 ? 'X' : '√' }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column label="办公自动化系统" prop="type1" align="center">
                    <template slot-scope="{ row }">
                        <el-tag>{{ row.type1 == 0 ? 'X' : '√' }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column label="状态" prop="type3" align="center">
                    <template slot-scope="{ row }">
