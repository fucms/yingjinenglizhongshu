  ...
  <div>
    <el-dialog :title="title" :visible.sync="visible" style="padding-bottom: 5vh" width="60%">
      <el-form ref="dataForm" :model="temp" label-position="left" label-width="auto" :rules="rules">
        <el-row>
          <el-col :span="12">
            <el-form-item label="事件名称" prop="customerCode">
              <el-input v-model="temp.customerCode1" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="事件类型" prop="customerCode">
              <el-input v-model="temp.customerCode2" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="发生地" prop="customerCode">
              <el-input v-model="temp.customerCode3" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="发生时间" prop="customerCode">
              <el-input v-model="temp.customerCode4" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="应急资源分布" prop="customerCode">
              <el-input v-model="temp.customerCode5" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="应急响应情况" prop="customerCode">
              <el-input v-model="temp.customerCode6" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="气象" prop="customerCode">
              <el-input v-model="temp.customerCode7" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="人口" prop="customerCode">
              <el-input v-model="temp.customerCode8" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="交通路况" prop="customerCode">
